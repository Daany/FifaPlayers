...
@property(nonatomic, strong) UITextField *maxGKReflexes;
@property(nonatomic, strong) UITextField *minGKPosition;
@property(nonatomic, strong) UITextField *maxGKPosition;
@end